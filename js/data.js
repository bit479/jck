...
const websiteData = {
  ...
  overseasMining: {
    ...
    overview: "特变电工自2006年进入塔吉克斯坦市场，2012年通过‘以资源换项目’方式取得上库马尔克和东杜奥巴两个矿区金矿采矿权。项目分期建设，自2021年起陆续投产，目前已形成稳定运营能力。",
    ...
    projects: [
      {
        id: "upper-kumarg-phase-1",
        name: "上库马尔克金矿一期",
        investment: "4.18亿元人民币",
        description: "项目采用三段一闭路破碎、堆浸、炭吸附、解吸电解及冶炼工艺，形成从矿石处理到黄金生产的完整工艺体系，是公司塔吉克斯坦金矿业务的重要一期工程。",
        metrics: [
          { label: "矿区面积", value: "15.4平方公里" },
          { label: "金金属量", value: "34.75吨" },
          { label: "设计规模", value: "90万吨/年" },
          { label: "年产黄金", value: "约1.2吨" },
      ...
      },
      {
        ...
        description: "项目采用地下井硐开采方式，建成后将进一步提升公司在塔吉克斯坦的黄金资源开发和规模化生产能力，并对当地矿业开发和经济发展发挥积极作用。",
        metrics: [
          { label: "探明金金属资源储量", value: "22.62吨" },
          { label: "开采方式", value: "地下井硐开采" },
          { label: "设计规模", value: "90万吨/年" },
          { label: "年产黄金", value: "约1.5吨" }
        ]
      },
      {
        id: "upper-kumarg-phase-2",
        name: "上库马尔克金矿二期项目",
        investment: "6500万美元",
        description: "项目聚焦高品位金矿资源的系统性开发，达产后将显著提升矿区黄金产能，标志上库马尔克矿区进入规模化商业开采阶段。",
        metrics: [
          { label: "平均品位", value: "3.78—3.83g/t" },
          { label: "探明储量", value: "约22.1吨" },
          { label: "预计新增年产黄金", value: "2.5吨" },
          { label: "远景资源量", value: "有望突破100吨" }
        ]
      }
    ],
    mapPanel: {
